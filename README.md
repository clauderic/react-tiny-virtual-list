...
| debounce          | Number            |           |  A number of milliseconds to wait after scrolling stops before recomputing and emitting onScroll                                                                                                                                                                                                                                                                                                                                     |
...
| onScroll          | Function          |           | Callback invoked whenever the scroll offset changes within the inner scrollable region. It has the following signature: `(scrollTop: number, event: UIEvent)`.                                                                                                                                                                                                                                                 |
